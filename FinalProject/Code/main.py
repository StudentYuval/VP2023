...
timing_json["stabilize"] = stabilization_block(paths.Input, paths.Stabilized, show_work=args.show_work)
timing_json["extract"] = bg_subtraction_block(paths.Stabilized, paths.Extracted, paths.Binary, show_work=args.show_work)
timing_json["binary"] = matting_block(paths.Extracted, paths.Binary, paths.Background, paths.Matted, paths.Alpha)
timing_json["track"] = tracking_block(paths.Matted, paths.Output, tracking_json)
